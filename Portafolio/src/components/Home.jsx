        ...
        <div className=" pt-10 xsm:pb-10 xsm:pt-20 md:pb-10 md:pt-40">
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            ...
            <div className='flex pt-20 pb-10 justify-around '>
              <a href='https://github.com/LuisH05' target='_blank' className='bg-black rounded-md hover:bg-[#03CC90]'>
              ...
              <a href='https://www.linkedin.com/in/luisherdez/' target='_blank' className='bg-black rounded-md hover:bg-[#03CC90]'>
              ...
              <a href='https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=new' target='_blank' className='bg-black rounded-md hover:bg-[#03CC90]'>
